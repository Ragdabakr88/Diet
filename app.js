...
// check if user choose rememberMe
...
app.use('/products', require('./routes/home/products'));
app.use('/resturant', require('./routes/home/resturant'));
app.use('/payment', require('./routes/home/payment'));
...
app.use('/admin/resturants', require('./routes/admin/resturants'));
